      ...
      <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
          <div>
            ...
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.9, marginBottom: '16px', fontSize: '1.02rem' }}>
              I've interned across three very different domains — software testing & IP at Innoventory Solutions, client engineering at Fouses, and neuromorphic hardware research at IIT Roorkee.
            </p>
